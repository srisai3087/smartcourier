...
/**
 * AuthServiceImplTest - Unit tests for AuthServiceImpl.
 *
 * Spring Modules Tested: Service layer business logic.
 *
 ...
 *
 * These tests run WITHOUT starting the Spring context (fast execution).
 */
